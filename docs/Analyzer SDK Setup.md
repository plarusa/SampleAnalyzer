...
As far as I can tell, version 1.1.18 does not show an option to set the analyzer directory. One way around this is just copying the dll being debugged to the Analyzer foler.
